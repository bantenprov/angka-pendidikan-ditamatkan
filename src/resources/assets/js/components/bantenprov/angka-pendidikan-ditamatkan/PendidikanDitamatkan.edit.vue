...
export default {
  mounted() {
    axios.get('api/angka-pendidikan-ditamatkan/' + this.$route.params.id + '/edit')
      .then(response => {
        if (response.data.status == true) {
          this.model.label = response.data.pendidikan_ditamatkan.label;
          this.model.old_label = response.data.pendidikan_ditamatkan.label;
          this.model.description = response.data.pendidikan_ditamatkan.description;
        } else {
          alert('Failed');
        }
      })
      .catch(function(response) {
        alert('Break');
        window.location.href = '#/admin/angka-pendidikan-ditamatkan';
      });
  },
  data() {
    return {
  ...
  methods: {
    onSubmit: function() {
      ...
      if (this.state.$invalid) {
        ...
        axios.put('api/angka-pendidikan-ditamatkan/' + this.$route.params.id, {
    ...
    back() {
      window.location = '#/admin/angka-pendidikan-ditamatkan';
    }
  }
}
</script>
