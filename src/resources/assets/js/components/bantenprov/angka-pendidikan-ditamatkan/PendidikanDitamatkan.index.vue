    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
        <vuetable ref="vuetable"
          api-url="/api/angka-pendidikan-ditamatkan"
          :fields="fields"
...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/angka-pendidikan-ditamatkan/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/angka-pendidikan-ditamatkan/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/angka-pendidikan-ditamatkan/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/angka-pendidikan-ditamatkan/' + rowData.id)
